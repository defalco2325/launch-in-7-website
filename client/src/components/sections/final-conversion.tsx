    ...
    <section className="py-20 bg-deep-navy text-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          {/* Guarantee Badge */}
          <div
            className="inline-flex items-center px-6 py-3 bg-success-green/20 border border-success-green/30 rounded-full text-success-green font-medium mb-8 animate-fade-in-up"
          >
          ...
          <div
            className="font-poppins font-bold text-3xl lg:text-5xl mb-6 animate-fade-in-up"
          ...
          <div
            className="text-xl text-gray-300 mb-12 max-w-2xl mx-auto animate-fade-in-up"
