    ...
    <form onSubmit={form.handleSubmit(onSubmit)} className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div>
        ...
        <Input
          ...
          className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-gray-400 focus:ring-2 focus:ring-electric-blue focus:border-transparent"
      ...
      <div>
        <Label htmlFor="audit-goal" className="block text-sm font-medium text-gray-300 mb-2">
          Primary Goal *
        </Label>
        <Select onValueChange={(value) => form.setValue("goal", value as any)} data-testid="select-audit-goal">
          <SelectTrigger className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white focus:ring-2 focus:ring-electric-blue focus:border-transparent">
      ...
      <div>
        <Label htmlFor="audit-timeline" className="block text-sm font-medium text-gray-300 mb-2">
          Timeline *
        </Label>
