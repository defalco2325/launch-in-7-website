        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div id="about-section" className="mb-16 h-[280px]">
            <div className="text-center mb-12 h-[140px]">
              ...
              <p 
                className="text-gray-300 text-lg max-w-4xl mx-auto leading-relaxed h-20"
              >
          ...
          <div id="contact-section" className="mb-12 h-[140px] flex flex-col justify-center">
            ...
            <div className="text-center">
              <p className="text-gray-300 mb-4 h-6">Ready to launch your website in just 7 days?</p>
              <a 
                href="tel:7025826584" 
                className="text-electric-blue hover:text-neon-cyan transition-colors font-semibold text-xl flex items-center justify-center mb-4 h-8"
                data-testid="footer-phone-contact"
              >
                <Phone className="w-5 h-5 mr-2" width="20" height="20" />
                702-582-6584
              </a>
              <p className="text-gray-400 text-sm h-5">Available Monday-Friday, 9 AM - 6 PM PST</p>
            </div>
          </div>
          ...
          <div className="border-t border-white/20 pt-8 flex flex-col md:flex-row items-center justify-between h-[100px]">
            <p className="text-gray-400 text-sm mb-4 md:mb-0 h-5">
