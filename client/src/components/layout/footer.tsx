...
export default function Footer() {
  return (
    <footer 
      className="bg-deep-navy text-white py-16 min-h-[600px] overflow-hidden"
      style={{ 
    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          {/* Contact Section */}
          <div id="contact-section" className="mb-16 pt-8">
            <h3 className="font-poppins font-bold text-2xl mb-6 text-center">Get In Touch</h3>
            <div className="text-center">
              <p className="text-gray-200 mb-4">Ready to launch your website in just 7 days?</p>
              <a 
                href="tel:7025826584" 
                className="text-sky-300 hover:text-cyan-200 underline underline-offset-2 transition-colors font-semibold text-xl flex items-center justify-center mb-4 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-300"
                data-testid="footer-phone-contact"
              >
                <Phone className="w-5 h-5 mr-2 fill-current text-gray-200" width="20" height="20" />
                702-582-6584
              </a>
              <p className="text-gray-200 text-sm">Available Monday-Friday, 9 AM - 6 PM PST</p>
            </div>
          </div>

          
          {/* Bottom Bar */}
          <div className="border-t border-white/20 pt-8 flex flex-col md:flex-row items-center justify-center">
