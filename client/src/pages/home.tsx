...
export default function Home() {
  ...
  return (
    <div className="l7-home">
      ...
      <section className="l7-section l7-proof" id="work-section"><div className="l7-section-num">04 <span>PROOF, WITHOUT THEATRE</span></div><div className="l7-proof-box"><div><h2>Specific proof<br /><em>over big claims.</em></h2><p>We are building a library of the work that matters: the before, the decision, the system, and what changed. Ask for the examples most relevant to your business.</p><Link href="/clients" className="l7-underlink">Request relevant examples <ArrowUpRight size={15} /></Link></div><div className="l7-proof-note"><span>SELECTED WORK / BEING CURATED</span><strong>Verified client stories<br />coming as they are approved.</strong><small>We will never fill this space with invented logos, testimonials, or metrics.</small></div></div></section>
