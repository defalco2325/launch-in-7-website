...
export default function SolutionPageTemplate({
  ...
  return (
    <div className="min-h-screen">
      {/* Hero */}
      <section className="bg-gradient-to-br from-deep-navy via-slate-900 to-deep-navy text-white py-28 relative overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-r from-electric-blue/5 to-accent-purple/5 rounded-full blur-3xl"></div>
